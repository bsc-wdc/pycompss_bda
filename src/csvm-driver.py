...
def main():    
    ...
    if args.centralized_read:
        ...
        csvm.fit(path=train_data, data_format="libsvm", n_features=args.f, kernel=args.k, C=args.c,
                           cascade_arity=args.a, n_partitions=args.n, gamma=gamma, cascade_iterations=args.i)
        
    else:
        csvm.fit(path=train_data, n_features=args.f, kernel=args.k, C=args.c, cascade_arity=args.a,
                           n_partitions=args.n, gamma=gamma, cascade_iterations=args.i)
       
        
    out = [args.k, args.a, args.n, csvm._clf_params["gamma"], args.c, csvm.iterations, csvm.converged,
